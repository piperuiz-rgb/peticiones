...
import pandas as pd
from utils import init_state, ensure_style, load_catalog_from_sidebar, merge_carts, cart_to_df, export_to_template_xlsx, openpyxl

st.set_page_config(page_title="Exportar", page_icon="⬇️", layout="wide")
ensure_style()
init_state()
tpl_bytes = load_catalog_from_sidebar()
